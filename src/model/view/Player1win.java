...
public class Player1win extends JFrame implements ActionListener{
	public static void main(String [] args){
		Player y = new Player("Omar");
		Player z = new Player("Ahmed");

		 Game game = new Game(y,z);
		Player1win x = new Player1win(game);
		x.setVisible(true);
	}
	public Player1win(Game game){
		setTitle(game.getPlayer1().getName()+" "+"Wins");
		setSize(1100, 528);
		...
		all.setIcon(new ImageIcon("src/player1wins.png"));
		setVisible(true);
